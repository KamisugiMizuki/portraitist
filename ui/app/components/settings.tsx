    ...
    <ErrorBoundary>
      ...
      <div className={styles["settings"]}>
        <List>
          ...
          <ListItem
            title={`${Locale.Settings.Update.Version} portraitist`}
            subTitle={Locale.Settings.Update.IsLatest}
          ></ListItem>
